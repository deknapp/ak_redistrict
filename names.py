...
PLACE_LIST = [ANCHORAGE, BETHEL, FAIRBANKS, VALDEZ_CORDOVA, NW_ARCTIC, MATSU, HYDER, JUNEAU, ALEUTIANS_EAST, ALEUTIANS_WEST, DENALI, BRISTOL,
KENAI, OUT_OF_STATE, HAINES, SE_FAIRBANKS, WRANGELL, SITKA, LAKE, DILLINGHAM, HAINES, HOONAH, KETCHIKAN, KODIAK, KUSILVAK, NOME, NORTH_SLOPE,
